# -*- coding: utf-8 -*-
"""
Created on Sat Aug 20 11:06:44 2016
...
apps = pd.merge(app_labels, label_categories, on='label_id', how='left')
if peek:
    print(apps.shape)
    
    
apps['general_groups'] = apps['category']     # create a new column
...
grouped_categories = apps['general_groups'].unique()
print('Grouped categories: ', grouped_categories)

apps = apps.drop(['label_id', 'category'], axis=1)   # drop useless columns

apps.to_csv('../processed_data/merged_app_category.csv')    
print('\nShape of apps: ', apps.shape)   # shape: (459943, 2)
print('\n', apps.head())
